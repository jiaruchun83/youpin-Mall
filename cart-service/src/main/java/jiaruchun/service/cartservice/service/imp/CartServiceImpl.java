package jiaruchun.service.cartservice.service.imp;
...
import jiaruchun.service.cartservice.mapper.CartMapper;
...
public class CartServiceImpl extends ServiceImpl<CartMapper, Cart> implements ICartService {
    ...
    private final ItemOpenFeignApi itemOPenFeignClientApi;
...
//        List<Cart> carts = lambdaQuery().eq(Cart::getUserId, UserContext.getUser()).list();
    ...
    private void handleCartItems(List<CartVO> vos) {
        ...
        // 2.查询商品
        List<ItemDTO> items = itemOPenFeignClientApi.queryItemByIds(itemIds);
