...
import jiaruchun.service.userservice.mapper.UserMapper;
...
import jiaruchun.service.userservice.service.IUserService;
import jiaruchun.service.userservice.utils.JwtUtil;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public UserLoginVO login(LoginFormDTO loginDTO) {
        ...
        claims.put(jwtProperties.getMapKeyName(),user.getId());
        String token = JwtUtil.creat4eJWT(jwtProperties.getSecretKey(),jwtProperties.getTokenTtl(),claims);
        // 6.封装VO返回
