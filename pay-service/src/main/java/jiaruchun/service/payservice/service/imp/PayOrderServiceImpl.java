package jiaruchun.service.payservice.service.imp;
...
import jiaruchun.api.openfeignclient.user.UserOPenFeignClientApi;
import jiaruchun.api.pojo.entity.Order;
import jiaruchun.service.payservice.mapper.PayOrderMapper;
...
public class PayOrderServiceImpl extends ServiceImpl<PayOrderMapper, PayOrder> implements IPayOrderService {
    ...
    private final UserOPenFeignClientApi userOPenFeignClientApi;
    ...
    public void tryPayOrderByBalance(PayOrderFormDTO payOrderFormDTO) {
        ...
        // 3.尝试扣减余额
        userOPenFeignClientApi.deductMoney(payOrderFormDTO.getPw(), po.getAmount());
        // 4.修改支付单状态
